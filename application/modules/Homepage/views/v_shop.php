...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__nav__option">
            <a href="#" class="search-switch"><img src="<?php echo base_url() ?>assets/img/icon/search.png" alt=""></a>
            <a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a>
            <a href="#"><img src="<?php echo base_url() ?>assets/img/icon/cart.png" alt=""> <span>0</span></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-2.jpg">
                                    <ul class="product__hover">
                                        ...
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-9.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item sale">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-10.jpg">
                                    <span class="label">Sale</span>
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-11.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item sale">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-12.jpg">
                                    <span class="label">Sale</span>
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-13.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?php echo base_url() ?>assets/img/product/product-14.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="<?php echo base_url() ?>assets/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
